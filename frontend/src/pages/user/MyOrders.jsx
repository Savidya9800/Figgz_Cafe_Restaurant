      ...
      setOrders([
        {
          ...
          total: 45.50,
          items: [
            { name: 'Margherita Pizza', quantity: 1, price: 22.50 },
            { name: 'Caesar Salad', quantity: 1, price: 15.00 },
        ...
        },
        {
          ...
          total: 67.80,
          items: [
            { name: 'Beef Burger', quantity: 2, price: 25.00 },
            { name: 'Sweet Potato Fries', quantity: 2, price: 8.90 },
            { name: 'Milkshake', quantity: 2, price: 8.90 }
          ],
        ...
        },
        {
          ...
          total: 34.20,
          items: [
            { name: 'Chicken Wrap', quantity: 1, price: 18.50 },
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <motion.div variants={itemVariants} className="text-center mb-12">
            <h1 className="text-4xl font-bold text-[#111111] mb-4">My Orders</h1>
            <p className="text-lg text-[#74787C] max-w-2xl mx-auto">
              Track your orders, reorder favorites, and manage your dining history
            </p>
          </motion.div>
                ...
                >
                  <div className="p-6">
                    ...
                    <div className="border-t border-gray-100 pt-4">
                      <h4 className="font-semibold text-[#111111] mb-3">Order Items</h4>
