...
function Stories() {
  ...
  const storiesItems = [
    {
      title: "The Beginning",
      description: "How Figgz Cafe started as a small family dream and grew into a beloved community gathering place.",
      link: "#",
      image: demo01
    },
    {
      title: "Community Love",
      description: "Stories from our valued customers who have made Figgz Cafe a part of their daily lives and special moments.",
      link: "#",
      image: demo02
    },
    {
      title: "Behind the Scenes",
      description: "Meet our passionate team of chefs, baristas, and staff who bring magic to every dish and cup.",
      link: "#",
      image: demo03
    },
    {
      title: "Special Moments",
      description: "Memorable celebrations, first dates, business meetings, and family gatherings that happened at Figgz.",
      link: "#",
      image: demo04
    },
    {
      title: "Recipe Heritage",
      description: "Traditional family recipes passed down through generations, now served with modern culinary artistry.",
      link: "#",
      image: demo05
    },
    {
      title: "Local Partnerships",
      description: "Our commitment to supporting local farmers, suppliers, and the community that embraces us.",
      link: "#",
      image: demo06
    }
  ];
  ...
  const journeyMilestones = [
    {
      ...
      description: "Founded with a simple vision: to create a warm, welcoming space where great food meets genuine hospitality.",
      image: demo07
    },
    {
      year: "2019",
      title: "First Location Opens",
      description: "Our flagship location opens its doors, serving the community with handcrafted meals and artisan coffee.",
      image: demo08
    },
    {
      year: "2020",
      title: "Community Support",
      description: "During challenging times, our community rallied around us, showing the true power of connection through food.",
      image: demo09
    },
    {
      year: "2021",
      title: "Menu Innovation",
      description: "Introduced seasonal menus and signature dishes that became local favorites and conversation starters.",
      image: demo11
    },
    {
      year: "2022",
      title: "Expansion & Growth",
      description: "Opened our second location, bringing the Figgz experience to even more families and food lovers.",
      image: demo12
    },
    {
      year: "2023",
      title: "Awards & Recognition",
      description: "Received multiple awards for culinary excellence and outstanding customer service in the region.",
      image: demo13
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <button
              onClick={() => {
                const storiesSection = document.querySelector('#stories-content')
                if (storiesSection) {
      ...
      <section id="stories-content" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-orange-50 via-red-50 to-amber-50 relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-sm sm:text-base px-4">
              From humble beginnings to cherished memories, these stories capture the essence of what makes 
              Figgz Cafe a special place in the hearts of our community.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <HoverEffect items={storiesItems} className="grid-cols-1 md:grid-cols-2 lg:grid-cols-3" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-sm sm:text-base px-4">
              Follow our remarkable journey from a small dream to becoming a beloved culinary destination 
              that brings people together through exceptional food and warm hospitality.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#111111] mb-4 sm:mb-6">
                THE HEART OF FIGGZ CAFE
              </h2>
              
              <div className="text-gray-600 leading-relaxed space-y-3 sm:space-y-4 text-sm sm:text-base">
                <p>
                  What started as a simple dream has blossomed into something truly special. 
                  Figgz Cafe was born from a passion for bringing people together through 
                  exceptional food, warm hospitality, and genuine connections.
                </p>
                <p>
                  Every recipe tells a story, from our grandmother's secret coffee blend 
                  to the innovative dishes our chefs craft daily. We believe that food 
                  is more than sustenance—it's a way to create memories, celebrate life, 
                  and build community.
                </p>
                <p>
                  Our commitment goes beyond just serving great food. We're dedicated to 
                  supporting local farmers, creating a welcoming space for all, and being 
                  an integral part of the community we proudly serve.
                </p>
              </div>
              ...
              <div className="relative overflow-hidden rounded-2xl shadow-2xl">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                    <h3 className="text-white font-bold text-lg mb-2">Where Stories Begin</h3>
                    <p className="text-white/90 text-sm">
                      Every corner of our cafe holds memories, laughter, and the warmth of community.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
              <div className="text-center">
                <div className="bg-white rounded-lg p-4 sm:p-6 shadow-lg">
                  <div className="text-2xl sm:text-3xl font-bold text-[#CB3A1A] mb-2">5+</div>
                  <div className="text-gray-600 text-sm sm:text-base">Years of Service</div>
                </div>
              </div>
              <div className="text-center">
                <div className="bg-white rounded-lg p-4 sm:p-6 shadow-lg">
                  <div className="text-2xl sm:text-3xl font-bold text-[#CB3A1A] mb-2">10K+</div>
                  <div className="text-gray-600 text-sm sm:text-base">Happy Customers</div>
                </div>
              </div>
              <div className="text-center">
                <div className="bg-white rounded-lg p-4 sm:p-6 shadow-lg">
                  <div className="text-2xl sm:text-3xl font-bold text-[#CB3A1A] mb-2">50+</div>
                  <div className="text-gray-600 text-sm sm:text-base">Menu Items</div>
                </div>
              </div>
              <div className="text-center">
                <div className="bg-white rounded-lg p-4 sm:p-6 shadow-lg">
                  <div className="text-2xl sm:text-3xl font-bold text-[#CB3A1A] mb-2">2</div>
                  <div className="text-gray-600 text-sm sm:text-base">Locations</div>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative bg-gradient-to-r from-[#CB3A1A] to-[#CB3A1A] rounded-xl p-4 sm:p-6 lg:p-8 text-center overflow-hidden max-w-4xl mx-auto">
              ...
              <div className="relative z-10">
                ...
                >
                  Figgz Cafe isn't just a place to eat—it's where our community comes together. 
                  The warmth of the staff, the quality of the food, and the atmosphere make 
                ...
                >
                  ...
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-white/20 rounded-full flex items-center justify-center border-2 border-white/30">
                    <span className="text-white text-sm sm:text-base font-bold">SM</span>
                  </div>
                  
                  {/* Customer Details */}
                  <div className="text-center sm:text-left">
                    <div className="text-white font-bold text-sm sm:text-base">Sarah Mitchell</div>
                    <div className="text-white/80 text-xs sm:text-sm">Regular Customer since 2019</div>
