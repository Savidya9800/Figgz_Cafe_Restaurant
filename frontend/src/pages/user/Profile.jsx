        ...
        <>
            <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-red-50">
                ...
                <motion.div variants={itemVariants} className="text-center mb-8">
                    ...
                    <p className="text-lg text-[#74787C]">Manage your profile and preferences</p>
                </motion.div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    {isEditing ? (
                                        <input
                                            ...
                                            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#CB3A1A] focus:border-transparent transition-all"
                                        />
                                    ) : (
                                        <p className="px-4 py-3 bg-gray-50 rounded-lg text-gray-800">{formData.name || 'Not provided'}</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="px-4 py-3 bg-gray-50 rounded-lg text-gray-800">{formData.email || 'Not provided'}</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="px-4 py-3 bg-gray-50 rounded-lg text-gray-800">{formData.phone || 'Not provided'}</p>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="px-4 py-3 bg-gray-50 rounded-lg text-gray-800">{formData.address || 'Not provided'}</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="px-4 py-3 bg-gray-50 rounded-lg text-gray-800">{formData.favoriteFood || 'Not provided'}</p>
                                    )}
                                </div>
                            </div>
                        </div>
                ...
                <motion.div variants={itemVariants} className="grid md:grid-cols-3 gap-6 mt-8">
                    <div className="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-all duration-300">
                        <div className="w-12 h-12 bg-[#CB3A1A]/10 rounded-lg flex items-center justify-center mx-auto mb-4">
                            <svg className="w-6 h-6 text-[#CB3A1A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                            </svg>
                        </div>
                ...
                <motion.div variants={itemVariants} className="mt-8 text-center">
                    <button
                        onClick={logout}
                        className="px-8 py-3 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-all duration-200 shadow-lg"
                    >
                        Sign Out
                    </button>
                </motion.div>
