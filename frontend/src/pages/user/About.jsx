...
function About() {
  ...
  // Helper to navigate and scroll to contact section
  ...
  const foodGalleryItems = [
    {
      ...
      description:
        "Explore our chef's special creations made with the finest ingredients and traditional recipes.",
      link: "#",
      image: demo01,
    },
    {
      ...
      description:
        "We source only the freshest, locally-grown ingredients to ensure the highest quality meals.",
      link: "#",
      image: demo02,
    },
    {
      ...
      description:
        "Our bakery crafts fresh breads daily using time-honored techniques and premium flour.",
      link: "#",
      image: demo03,
    },
    {
      ...
      description:
        "Start your day with our expertly roasted coffee beans sourced from premium farms worldwide.",
      link: "#",
      image: demo04,
    },
    {
      ...
      description:
        "Indulge in our house-made desserts and pastries, perfect for any sweet craving.",
      link: "#",
      image: demo05,
    },
    {
      ...
      description:
        "Discover our rotating menu of seasonal dishes that celebrate the best of each season.",
      link: "#",
      image: demo06,
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <div className="text-gray-600 leading-relaxed space-y-3 sm:space-y-4 text-sm sm:text-base">
                <p>
                  At Figgz Cafe, we believe food is more than just a meal — it's
                  a moment of connection.
                </p>
                <p>
                  From our humble beginnings in Bowen Hills to our buzzing
                  Taringa location, we've grown with one simple philosophy:
                  serve fresh, serve local, and serve with heart.
                </p>
                <p>
                  Every dish we create is made in-house, using quality
                  ingredients sourced with care. Whether you're grabbing your
                  morning coffee or sitting down for dinner with friends, you'll
                  always find honest food, warm smiles, and a welcoming space at
                  Figgz.
                </p>
                <p>
                  Join us and discover what makes our community café experience
                  so special.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-sm sm:text-base px-4">
              Discover our culinary masterpieces through our food gallery. Each
              dish tells a story of passion, creativity, and the finest
              ingredients crafted by our expert chefs.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="group bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-xs sm:text-sm leading-relaxed">
                  Consectetur adipiscing elit quspue egert maximus velit, non
                  eleifend libero cursbler dignissim mauris sed leo cursus
                </p>
              </div>
            </div>
            ...
            <div className="group bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 md:col-span-2 lg:col-span-1">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-xs sm:text-sm leading-relaxed">
                  Enjoy our rich, handcrafted coffee made with Botero beans.
                  From smooth lattes to bold espressos, we brew every cup with
