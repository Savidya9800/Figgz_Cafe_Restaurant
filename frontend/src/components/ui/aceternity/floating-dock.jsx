...
const FloatingDockDesktop = ({
  ...
  // Check if it's a vertical layout (contains flex-col in className)
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden gap-4 rounded-2xl bg-gray-50 px-4 pb-3 md:flex dark:bg-neutral-900",
        isVertical ? "h-auto w-16 flex-col items-center py-4" : "h-16 items-end",
        className
      )}>
      {items.map((item) => (
        <IconContainer 
