...
const GoogleLoginButton = ({ onSuccess, onError, className = '' }) => {
    ...
    return (
        <button
            ...
            className={`flex items-center justify-center gap-3 w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200 ${className}`}
        >
            <svg
                className="w-5 h-5"
                viewBox="0 0 24 24"
